      ...
      {outcome === 'won' ? (
        <div className="max-w-4xl space-y-12 animate-in zoom-in-95 duration-1000">
          <div className="space-y-4">
            ...
            <p className="text-cyan-400 font-mono text-xl tracking-[0.3em] uppercase">Level 10: The Invisible Hook Cleared</p>
          </div>
          ...
          <button onClick={() => {
            ...
            enterLevel(11);
          }} className="bg-indigo-600 hover:bg-indigo-500 px-24 py-10 rounded-[60px] text-2xl font-black italic uppercase transition-all shadow-[0_20px_50px_rgba(79,70,229,0.4)] hover:-translate-y-2">CONTINUE_MISSION_L11</button>
        </div>
      ) : (
        <div className="space-y-12 animate-in zoom-in-95">
          ...
          <button onClick={() => {
            ...
            setTraceStep(0);
          }} className="bg-zinc-900 border-2 border-white/10 px-20 py-10 rounded-[60px] text-lg font-black italic uppercase">TERMINATE_L10_RETRY</button>
        </div>
      )}
    </div>
  );
  ...
  const InvestigationBoard = () => (
    <div className="fixed inset-y-14 right-14 w-[650px] bg-[#d9af82] p-12 flex flex-col border-[20px] border-[#3f2b1d] z-[300] overflow-y-auto">
      <div className="bg-white/90 p-5 mb-12 flex justify-between items-center text-black">
        <h2 className="text-2xl font-black uppercase italic">EVIDENTIARY_RECORD_v10</h2>
