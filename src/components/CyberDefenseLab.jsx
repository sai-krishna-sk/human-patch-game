    ...
    const renderArcadeSelection = () => (
        <div className="flex flex-col items-center w-full max-w-6xl px-6 animate-fade-in h-full py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
                ...
                {/* 2. DDOS Defense */}
                <div
                    onClick={() => { setActiveGame('DDOSDefense'); setView('playing'); }}
                    className="group bg-slate-900/50 border border-slate-800 p-6 rounded-xl hover:border-cyan-500/30 hover:bg-cyan-500/5 transition-all cursor-pointer relative overflow-hidden"
                >
                    <div className="flex items-start justify-between mb-4">
                        <span className="text-3xl">🛡️</span>
                        <span className="text-[10px] font-mono text-slate-600 bg-slate-950 px-2 py-1 rounded">ARCADE_02</span>
                    </div>
                    <h3 className="text-xl font-bold text-white mb-2 uppercase tracking-tighter">DDoS Defense</h3>
                    <p className="text-slate-400 text-sm mb-4">Protect the core from malicious traffic floods! Build firewalls and rate limiters to filter packets.</p>
                    <div className="w-full h-1 bg-slate-800 rounded overflow-hidden">
                        <div className="h-full bg-cyan-500 w-full animate-pulse"></div>
                    </div>
                </div>
                ...
                {/* 3. Botnet Survivors */}
                <div
                    onClick={() => { setActiveGame('BotnetSurvivors'); setView('playing'); }}
                    className="group bg-slate-900/50 border border-slate-800 p-6 rounded-xl hover:border-purple-500/30 hover:bg-purple-500/5 transition-all cursor-pointer relative overflow-hidden"
                >
                    <div className="flex items-start justify-between mb-4">
                        <span className="text-3xl">🎛️</span>
                        <span className="text-[10px] font-mono text-slate-600 bg-slate-950 px-2 py-1 rounded">ARCADE_03</span>
                    </div>
                    <h3 className="text-xl font-bold text-white mb-2 uppercase tracking-tighter">Botnet Survivors</h3>
                    <p className="text-slate-400 text-sm mb-4">Maneuver the core server through a global DDoS swarm. Level up and deploy layered defenses!</p>
                    <div className="w-full h-1 bg-slate-800 rounded overflow-hidden">
